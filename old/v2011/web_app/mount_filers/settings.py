# Django settings for mount_filers project.
...
if os.uname()[1] == "enacit1pc8":
    CONTEXT, DEBUG = "dev", True
else:
    if ROOT_PATH.find('django_test') != -1:
        CONTEXT, DEBUG = "test", True
    else:
        CONTEXT, DEBUG = "prod", False
